package com.xiaqi.myJava.java.concurrent.collection;
...
public class ConcurrentHashMap8<K, V> {
    ...
    private final void addCount(long x, int check) {
        ...
        if ((as = counterCells) != null || !U.compareAndSwapLong(this, BASECOUNT, b = baseCount, s = b + x)) {
            ...
            if (as == null || (m = as.length - 1) < 0 || (a = as[m]) == null || !(uncontended = U.compareAndSwapLong(a, CELLVALUE, v = a.value, v + x))) {
    ...
    private static final long BASECOUNT;// baseCount内存中的值
